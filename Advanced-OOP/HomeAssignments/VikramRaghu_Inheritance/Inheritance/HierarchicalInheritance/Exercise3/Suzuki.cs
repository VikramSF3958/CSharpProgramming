...
namespace Exercise3
{
    public class Suzuki : CarInfo
    {
        ...
        public Suzuki(string carModelName, string carModelNumber, string rcNumber, string engineNumber, string chasisNumber, int tankCapacity, int seats, int kmDriven, DateTime dateOfPurchase) : base(rcNumber, engineNumber, chasisNumber, tankCapacity, seats, kmDriven, dateOfPurchase)
        {
